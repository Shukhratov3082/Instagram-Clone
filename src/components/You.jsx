      ...
      <div className="obshiy">
        ...
        <div className="New">
          ...
          <div>
            ...
            <p>
              karennne liked your photo. <span>1h</span>
            </p>
            <img
        ...
        <div className="Today">
          ...
          <div>
            ...
            <p>
              kiero_d, zackjohn and 26 others <br /> liked your photo.{" "}
              <span>3h</span>
            </p>
            <img src={image2} alt="" />
          </div>
        ...
        <div className="This-week">
          ...
          <div className="craig-love">
            ...
            <p>
              {" "}
              <b>craig_love </b> mentioned you in a comment:{" "}
              <span>@jacob_w </span> exactly..
              <br /> 2<span className="gray">d</span>
            </p>
            <img
          ...
          <div className="Profiles">
            <div>
              ...
              <p>
                {" "}
                <b>martini_rond </b> started <br /> following you.
                <span>3d</span>
              </p>
            ...
            <div>
              ...
              <p>
                {" "}
                <b>maxjacobson</b> zackjohn and 26 others <br /> liked your
                photo. <span>3d</span>
              </p>
              <button className="message">Message</button>
            </div>
            <div>
              ...
              <p>
                <b>mis_potter</b> started following <br /> you. <span>3h</span>
              </p>
