...
import Controller from "./FooterBar";
const Following = () => {
  return (
    <Wrapper id="wrapper">
      <header>
      ...
      <div className="obshiy">
        <div className="box1">
          <div>
            <div className="top">
              ...
              <p>
                karennne liked your 3 photo. <span>3h</span>
              </p>
            </div>
        ...
        <div className="box3">
          <div>
            ...
            <p>
              {" "}
              <b>kiero_d </b> started following <br /> <b>craig_love.</b>{" "}
              <span>3h</span>
            </p>
          </div>
        </div>
        ...
        <div className="box5">
          <div>
            <img src={Profile2} alt="" />
            <p>
              maxjacobson and zackjohn liked <b>mis_potter’s</b> post.{" "}
              <span>3h</span>
            </p>
            <img src={image2} alt="" />
          </div>
        ...
        <div className="box7">
          <div>
            ...
            <p>
              karennne liked <b> martini_rond’s </b> <br /> comment:
              <span>@martini_rond </span>Nice!<span className="gray">3d</span>
            </p>
            <img
